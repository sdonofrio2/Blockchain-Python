...
################################################################################
# For this project, you will assume the perspective of a Fintech Finder
...
def get_people():
    """Create 4 columns for the different profiles."""
...
address = st.sidebar.write(account.address)
...
hours = st.sidebar.number_input("Number of Hours", step = 1)

st.sidebar.markdown("## Selected Candidate Information")
...
st.sidebar.write(f" Ethereum wallet Address : {candidate_address}")
...
# rate from the candidate database 
wage = candidate_database[person][3]*hours

# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write(f"You have earned {wage} ETH.")
